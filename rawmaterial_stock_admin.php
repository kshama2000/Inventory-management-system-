...
// select all data
$sql = "SELECT id, product,stock FROM raw_materials";
...
//check if more than 0 record found
 ...
 if ($result->num_rows > 0) {
    ...
    echo "<tr>";
        echo "<th>ID</th>";
        echo "<th>PRODUCT</th>";
        echo "<th>Current Stock in Units</th>";
        echo "<th>Action</th>";
    echo "</tr>";
...
while($row = $result->fetch_assoc()){
    ...
    echo "<tr>";
        ...
        echo "<td>";
            ...
            echo "<a href='update_rawmaterial_admin.php?id={$id}' class='btn btn-primary m-r-1em' target='_blank' >Add Inventory</a>";
