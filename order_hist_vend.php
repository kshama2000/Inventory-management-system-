...
.m-r-1em{ margin-right:1em; }
  ...
  <div class="container-fluid">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="pending_vendororders.php">Pending Orders</a>
          </li>
		  <li class="nav-item">
...
// select all data
$sql = "SELECT id, date_order, date_clrd FROM vendor_orders where stat=1 and customer_id=".$_SESSION['user_id'].";";
