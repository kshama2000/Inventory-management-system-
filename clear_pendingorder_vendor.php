  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="order_hist_vend.php">Order History</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="pending_order_vend.php">Pending Orders</a>
          </li>
		  <li class="nav-item">
            <a class="nav-link" href="vendorlogout.php">Logout</a>
          </li>
...
$sql = "SELECT b.product,a.qty,a.product_id from vendor_order_items a,raw_materials b where a.product_id=b.id and a.order_id=".$id.";";
...
while($row = $result->fetch_assoc()){
    ...
    echo "<tr>";
        ...
        $sqlsum = "SELECT stock FROM raw_materials WHERE id=".$row["product_id"].";";
...
if($_POST){
	...
	$id = $_POST['fname'];
		...
		$sql2 = "update vendor_orders set stat=1,date_clrd=now() where id=".$id.";";
		//echo $sql2;
		
		if ($conn->query($sql2) === TRUE) {
			
$sql3 = "SELECT product_id,qty FROM vendor_order_items where order_id=".$id.";";
...
window.location="pending_vendororders.php";
</script>
<?php
