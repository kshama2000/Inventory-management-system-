...
while($row = $result->fetch_assoc()){
	...
	<td class="a-center "><input type="text" class="flat" name="product[]" size="18" value="<?php echo $row['product'] ?>" readonly /></td>
...
//$conn->close();
    ...
    if(!empty($_POST['id'])) {
        ...
        foreach($_POST['id'] as $value){
			...
			$sql99 = "SELECT  FROM orders order by id desc limit 1";
			$result2 = $conn->query($sql2);
