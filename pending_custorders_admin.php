...
// select all data
$sql = "SELECT id, date_order FROM orders where stat=0";
...
while($row = $result->fetch_assoc()){
    ...
    echo "<tr>";
        ...
        $sqlsum = "SELECT SUM(amt) amount FROM order_items WHERE order_id=".$row["id"].";";
        ...
        echo "<td>";
            // read one record 
            echo "<a href='read_one.php?id={$id}' class='btn btn-info m-r-1em' target='_blank' >Read</a>";
             
            // we will use this links on next part of this post
            echo "<a href='clear_pending_orders_admin.php?id={$id}' class='btn btn-primary m-r-1em'>Clear</a>";
