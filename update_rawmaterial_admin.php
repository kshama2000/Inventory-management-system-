...
$sql = "SELECT id, product, stock FROM raw_materials WHERE id =".$id.";";
...
if($_POST){
        ...
        $sql2 = "update raw_materials set stock=stock+".$inv." where id =".$id.";";
...
window.location="rawmaterial_stock_admin.php";
</script>
<?php
    ...
    <table class='table table-hover table-responsive table-bordered'>
        ...
        <tr>
            ...
            <td>
                ...
                <a href='rawmaterial_stock_admin.php' class='btn btn-danger'>Back to Inventory Page</a>
            </td>
        </tr>
    </table>
</form>
